class SeladaRepository {
  final List<Map<String, dynamic>> data = [
    {
      ...
      "deskripsi": r"""
          ...
          <ul style="list-style-type: circle;">
            <li><span style="color: #ff0000;">Hari 0-2:</span> Benih selada ditanam di pot yang telah disiapkan dengan media tanam.</li>
    ...
    },
    {
      ...
      "deskripsi": r"""
          ...
          <ul style="list-style-type: circle;">
            ...
            <li><span style="color: #ff0000;">Panen:</span> Selada dapat dipanen sekitar 6-8 minggu setelah tanam. Potong seluruh bagian tanaman di dekat pangkal. Pastikan untuk memanen sebelum tanaman berbunga untuk mendapatkan kualitas daun yang terbaik.</li>
          </ul>
        """,
      "foto": "assets/images/tutorial/selada.png",
    },
  ...
  List<Map<String, dynamic>> getSeladaData() {
    return data;
  }
}
