              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (suggestion.pompaDurationSeconds > 0)
                    ...
                    if (suggestion.isSequential) ...[
                      _buildTimerRow(
                        color: Colors.teal,
                        icon: Icons.science,
                        label: 'Step 1 — pH Correction: ${suggestion.durationSeconds}s',
                      ),
                      const SizedBox(height: 6),
                      _buildTimerRow(
                        color: Colors.blue,
                        icon: Icons.water_drop,
                        label: 'Step 2 — Irrigation: ${suggestion.pompaDurationSeconds}s',
                      ),
                    ] else if (suggestion.durationSeconds > 0) ...[
                      _buildTimerRow(
                        color: Colors.purple,
                        icon: Icons.timer,
